...
export default class Wagon {
    constructor(_options) {
        ...
        this.textMap = {
            'Gate1': "Welcome aboard! Press 'M' or interact with the control panel above For a hidden surprise, try clicking around the bottom of the screen to discover and use the joystick for navigation. You can click the Menu icon and Explore other features. Enjoy the voyage!",
